...
class RegressionMeasurements(object):
    ...
    def add_result(self, y_true, y_pred):
        ...
        # Added by Ankit
        self.y_true_vector.append(y_true)
        self.y_pred_vector.append(y_pred)
    ...
    def get_mean_absolute_percentage_error(self):
        ...
        """
        actual, pred = np.array(self.y_true_vector), np.array(self.y_pred_vector)
        mask = actual != 0
...
class WindowRegressionMeasurements(object):
    ...
    # Added by Ankit
    def get_mean_absolute_percentage_error(self):
        """ Computes the window/current mean absolute percentage error.

        Returns
        -------
        float
            The window/current mean absolute percentage error.
